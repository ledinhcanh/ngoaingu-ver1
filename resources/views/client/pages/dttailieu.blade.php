    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center">
          <h2 class="mb-4 bread">{{ $loaitailieu1[0]->name }}</h2>
...
<div class="container">
    <div class="row">
    <div class="col-lg-8 ftco-animate" style="color:#000000;">
        <h2 class="mb-2">{{ $tailieu->name }}</h2>
        <div class="fb-like mb-3" data-href="http://127.0.0.1:8000/tin/{{ $tailieu->slug }}" data-width="" data-layout="button_count" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
        @if ($tailieu->content)
             {!! $tailieu->content !!}
        @endif
        <div class="download" style="text-align: center;"><a href="file/{{ $tailieu->file }}" download="{{ $tailieu->file }}" style="font-size:20px; color: #000000;"><i class="fa fa-download pr-2 pt-4"></i>Tải về</a></div>
        <div class="fb-comments" data-href="http://127.0.0.1:8000/tin/{{ $tailieu->slug }}" data-width="730" data-numposts="5" style=""></div>
    </div> <!-- .col-md-8 -->
