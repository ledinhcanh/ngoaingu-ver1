    ...
    <div class="row no-gutters slider-text align-items-center justify-content-center">
      <div class="col-md-9 ftco-animate text-center">
        ...
        <p class="breadcrumbs text-center"><span class="mr-2"><a href="/">Trang chủ <i
                class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2">Việc làm</span></p>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="row">
      <div class="col-lg-8">
        ...
        <div class="block-21 mb-4 d-flex"
          ...
          <a class="blog-img-tt mr-3" style="background-image: url(img/upload/trang/{{ $tt->image }}); background-size: cover;"></a>
          <div class="text" style="text-align: justify; padding: 5px;">
            <h3 class="heading" style="font-size: 20px;margin-bottom: 0px;"><a
                href="viec-lam/{{ $tt->slug }}">{{ $tt->title }}</a></h3>
            <div class="meta">
            ...
            ?>, {{ \Carbon\Carbon::parse($tt->updated_at)->format(' d')}} Tháng {{ \Carbon\Carbon::parse($tt->updated_at)->format(' m Y H:i A')}}</div>
      ...
      @endforeach
      <div class="float-right">{{ $trang->links() }}</div>
    </div>
