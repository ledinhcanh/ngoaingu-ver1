  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-center justify-content-center">
      <div class="col-md-9 ftco-animate text-center">
        ...
        <p class="breadcrumbs text-center"><span class="mr-2"><a href="/"><i class="fa fa-home pr-2" aria-hidden="true"
                style="font-size: 22px;"></i>Trang chủ</a></span></p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 color ftco-animate eimg" style="color:#000000;">
        ...
        <div class="fb-like mb-3" data-href="http://127.0.0.1:8000/tin/{{ $tintuc->slug }}" data-width=""
          data-layout="button_count" data-action="like" data-size="small" data-show-faces="true" data-share="true">
        </div>
        {!! $tintuc->content !!}
        <hr>
        @if (isset($tintheodong))
        @foreach ($tintheodong as $tt)
        @if ($tt->title != $tintuc->title)
        <p><a href="tin/{{ $tt->slug }}">{{ $tt->title }}</a></p>
        @endif
        @endforeach
        @endif
        <div class="fb-comments" data-href="http://127.0.0.1:8000/tin/{{ $tintuc->slug }}" data-width="730"
          data-numposts="5" style=""></div>
      </div> <!-- .col-md-8 -->
      ...
      <div class="col-lg-4 sidebar ftco-animate">
        ...
        <div class="sidebar-box ftco-animate">
          <h3 style="font-size: 20px;font-weight: 700;">Tin liên quan</h3>
          @foreach ($tintuc1 as $tb)
          <div class="block-21 mb-2 d-flex" style="border-bottom: 1px dashed #ddd; padding-bottom: 13px;">
