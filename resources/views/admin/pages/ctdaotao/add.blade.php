...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <form role="form" method="POST" action="{{ route('ctdaotao.store') }}">
                @csrf
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="code" placeholder="Nhập mã học phần" />
                                @if ($errors->has('code'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="number" placeholder="Nhập số tín chỉ" />
